// Mechanical — generated by @litlab/audx (do not edit)
// patch: Mechanical
import type { SoundDefinition, SoundPatch } from "@litlab/audx";

export const tap: SoundDefinition = {
	source: { type: "noise", color: "white" },
	filter: { type: "bandpass", frequency: 4000, resonance: 3 },
...
export const checkbox: SoundDefinition = {
	...
	filter: {
		...
		frequency: 3500,
		resonance: 4,
		envelope: { attack: 0, peak: 5000, decay: 0.03 },
	},
...
export const select: SoundDefinition = {
	source: { type: "noise", color: "white" },
	filter: { type: "bandpass", frequency: 3000, resonance: 3.5 },
	envelope: { attack: 0, decay: 0.025, sustain: 0, release: 0.008 },
	gain: 0.12,
};
export const deselect: SoundDefinition = {
	source: { type: "noise", color: "pink" },
	filter: { type: "bandpass", frequency: 2500, resonance: 3 },
	envelope: { attack: 0, decay: 0.02, sustain: 0, release: 0.006 },
	gain: 0.1,
};
...
export const tabSwitch: SoundDefinition = {
	...
	filter: {
		...
		frequency: 2500,
		resonance: 2.5,
		envelope: { attack: 0.005, peak: 5000, decay: 0.04 },
	},
...
export const expand: SoundDefinition = {
	...
	envelope: { attack: 0.005, decay: 0.1, sustain: 0, release: 0.03 },
	gain: 0.08,
};
...
export const pageEnter: SoundDefinition = {
	...
	filter: {
		...
		frequency: 400,
		resonance: 1.5,
		envelope: { attack: 0.02, peak: 3500, decay: 0.12 },
	},
...
export const success: SoundDefinition = {
	layers: [
		...
		{
			source: { type: "noise", color: "white" },
			filter: { type: "bandpass", frequency: 3500, resonance: 3 },
			envelope: { attack: 0, decay: 0.025, sustain: 0, release: 0.008 },
			delay: 0.05,
			gain: 0.1,
		},
		{
			source: { type: "noise", color: "white" },
			filter: { type: "bandpass", frequency: 5000, resonance: 3 },
			envelope: { attack: 0, decay: 0.02, sustain: 0, release: 0.006 },
			delay: 0.1,
			gain: 0.08,
		},
...
export const error: SoundDefinition = {
	layers: [
		{
			source: { type: "noise", color: "pink" },
			filter: { type: "bandpass", frequency: 1500, resonance: 4 },
			envelope: { attack: 0, decay: 0.06, sustain: 0, release: 0.02 },
			gain: 0.14,
		},
		{
			source: { type: "noise", color: "pink" },
			filter: { type: "bandpass", frequency: 800, resonance: 3 },
...
export const warning: SoundDefinition = {
	layers: [
		{
			source: { type: "noise", color: "white" },
			filter: { type: "bandpass", frequency: 2000, resonance: 4 },
			envelope: { attack: 0, decay: 0.04, sustain: 0, release: 0.012 },
			gain: 0.12,
		},
		{
			source: { type: "noise", color: "white" },
			filter: { type: "bandpass", frequency: 2100, resonance: 4 },
			envelope: { attack: 0, decay: 0.04, sustain: 0, release: 0.012 },
			delay: 0.01,
			gain: 0.1,
		},
...
export const notification: SoundDefinition = {
	layers: [
		{
			source: { type: "noise", color: "white" },
			filter: { type: "bandpass", frequency: 2500, resonance: 4 },
			envelope: { attack: 0, decay: 0.06, sustain: 0, release: 0.02 },
			gain: 0.12,
		},
		{
			source: { type: "noise", color: "white" },
			filter: { type: "bandpass", frequency: 4000, resonance: 3.5 },
			envelope: { attack: 0, decay: 0.05, sustain: 0, release: 0.015 },
			delay: 0.07,
			gain: 0.1,
		},
...
export const send: SoundDefinition = {
	...
	filter: {
		...
		frequency: 500,
		resonance: 2,
		envelope: { attack: 0.005, peak: 5000, decay: 0.1 },
	},
...
export const pop: SoundDefinition = {
	source: { type: "noise", color: "white" },
	filter: { type: "bandpass", frequency: 5000, resonance: 5 },
	envelope: { attack: 0, decay: 0.025, sustain: 0, release: 0.008 },
	gain: 0.14,
};
...
export const slide: SoundDefinition = {
	...
	filter: {
		...
		frequency: 500,
		resonance: 1.5,
		envelope: { attack: 0.015, peak: 3500, decay: 0.08 },
	},
	envelope: { attack: 0.008, decay: 0.1, sustain: 0, release: 0.035 },
	gain: 0.08,
};
...
export const _patch: SoundPatch = {
	...{
		...
		version: "1.0.0",
		description:
			"Noise-based, clicky, tactile sounds — industrial and precise UI feedback",
		tags: ["ui", "mechanical", "industrial", "tactile"],
	},
	sounds: {
		tap,
		click,
