// Core — generated by @litlab/audx (do not edit)
// patch: Core
...
export const whoosh: SoundDefinition = {
	...
	filter: {
		...
		frequency: 300,
		resonance: 1.5,
		envelope: { attack: 0.04, peak: 4000, decay: 0.16 },
	},
...
export const pageEnter: SoundDefinition = {
	...
	filter: {
		...
		frequency: 400,
		resonance: 1.2,
		envelope: { attack: 0.03, peak: 3000, decay: 0.15 },
	},
...
export const _patch: SoundPatch = {
	...{
		...
		version: "3.1.0",
		description:
			"Essential UI interaction sounds — clicks, toggles, pops, notifications, transitions, and more",
		tags: ["ui", "interactions", "feedback", "transitions", "notifications"],
	},
	sounds: {
		click,
		tap,
