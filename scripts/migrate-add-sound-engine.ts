 ...
 * - Adds "registry/audx/lib/sound-engine.ts" to each sound item's files array
 *
 * Usage:
...
const SOUND_ENGINE_FILE = {
	path: "registry/audx/lib/sound-engine.ts",
	type: "registry:lib",
};
