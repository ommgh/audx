...
name: create-sound
description: >-
  Generate a SoundDefinition for @litlab/audx from any input - a
...
Always return a TypeScript snippet ready to paste into a `.themes/<patch>.ts` file:

```ts
import type { SoundDefinition } from "@litlab/audx";
...
```ts
import { renderToWav } from "@litlab/audx";
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `click`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `complete`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `error`, `_delete`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `modalClose`, `drawerClose`, `dropdownClose`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `modalOpen`, `drawerOpen`, `dropdownOpen`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `notification`, `ding`, `mention`, `badge`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `success`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `swoosh`, `slide`, `slideUp`, `slideDown`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `tap`, `keyPress`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `tick`, `scrollSnap`, `focus`, `blur`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `toggleOn`, `toggleOff`, `copy`, `sync`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `whoosh`, `pageEnter`, `pageExit`.
...
Reference: [.themes/core.ts](../../../.themes/core.ts) `ding`, `sparkle`, `star`.
...
- `source.fm: { ratio: 2.76, depth: 300-400 }` - 2.76 is the inharmonic ratio used by `badge` in `.themes/core.ts` and reads as bell-metal.
- Short release; metallic shouldn't sustain.

Avoid stacking with `mood-warm` - they cancel each other out.

Reference: [.themes/core.ts](../../../.themes/core.ts) `badge`.
