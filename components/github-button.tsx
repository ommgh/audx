...
const fetchGithubStars = async (): Promise<number> => {
	try {
		const res = await fetch("https://api.github.com/repos/ommgh/audx", {
			headers: {
...
const GithubStartsButton = async () => {
	...
	return (
		<a
			className="group/github-stars border flex items-center gap-2 px-2.5 py-1.5 focus-within:outline-offset-2 focus-visible:outline-1 focus-visible:outline-primary"
			href="https://github.com/ommgh/audx"
